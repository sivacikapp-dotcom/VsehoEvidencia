    ...
    <div className="flex-1 overflow-auto p-8">
      <DocumentDetailClient
        document={{
          ...
          datumUcinnosti: isAppAdmin ? null : (doc.datumUcinnosti?.toISOString().split("T")[0] ?? doc.datumSchvalenia.toISOString().split("T")[0]),
          ...
          prilohaLink: (isAppAdmin || attachmentOnlyMode) ? null : doc.prilohaLink,
